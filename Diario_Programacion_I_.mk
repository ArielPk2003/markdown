...
command: ** la palabra ** 		----> Hará el texto más marcado

command: * koa *		  	 	----> Hará el texto cursivo

command: *** Pac.mi ***			----> Combinara negritas con cursiva

Tachado command: ~~ Tachado ~~	----> Tachara el texto
...
* La intención de la creación de este lenguaje fue extender al lenguaje de programación C y añadir mecanismos que permiten la manipulación de objetos. En ese sentido, desde el punto de vista de los lenguajes orientados a objetos, C++ es un lenguaje híbrido.
* Extensión -> archivo.cpp
* En lugar de gcc ahora se usará g++
